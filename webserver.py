...
def indeks(): 
    ...
    for num in toxbot.self_get_friend_list():
		...
		arkadaslar+="<tr><td>"+str(num)+"</td><td>"+toxbot.friend_get_name(num)+"</td><td>"+str(toxbot.friend_get_status_message(num))+"</td><td>"+str(toxbot.friend_get_public_key(num))+"</td></tr>"
